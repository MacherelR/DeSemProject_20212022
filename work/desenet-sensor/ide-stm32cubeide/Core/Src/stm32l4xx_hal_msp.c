...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_12|DISP_SPI2_SCK_Pin|DISP_SPI2_MISO_Pin|DISP_SPI2_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, NRF_CLK_Pin|NRF_MISO_Pin|NRF_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB1     ------> USART3_RTS
    */
    HAL_GPIO_DeInit(TRACE_CTS_GPIO_Port, TRACE_CTS_Pin);

    HAL_GPIO_DeInit(GPIOC, TRACE_TX_Pin|TRACE_RX_Pin);

    HAL_GPIO_DeInit(TRACE_RTS_GPIO_Port, TRACE_RTS_Pin);
